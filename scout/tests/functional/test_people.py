...
class TestPeopleController(TestController):
    ...
    def test_update(self):
        ...
        self.assertEqualJSON(self.app.post(url('person_update_')), 0)
        # Add people
        Session.add(model.Person(username, model.hashString(password), nickname, email))
        ...
        self.assertEqualJSON(self.app.post(url('person_update_'), dict(username=username_, password=password_, nickname=nickname_, email=email_)), 1)
        ...
        self.app.post(url('person_login_'), dict(username=username, password=password))
        self.assertEqualJSON(self.app.post(url('person_update_'), dict(smsAddressID=smsAddressID, action='activate')), 0)
        self.assertEqualJSON(self.app.post(url('person_update_'), dict(smsAddressID=smsAddressID, action='deactivate')), 0)
        self.assertEqualJSON(self.app.post(url('person_update_'), dict(smsAddressID=smsAddressID, action='remove')), 0)
        self.app.post(url('person_login_'), dict(username=username + 'x', password=password))
        self.assertEqualJSON(self.app.post(url('person_update_'), dict(smsAddressID=smsAddressID, action='activate')), 1)
        self.assertEqualJSON(self.app.post(url('person_update_'), dict(smsAddressID=smsAddressID, action='deactivate')), 1)
        self.assertEqualJSON(self.app.post(url('person_update_'), dict(smsAddressID=smsAddressID, action='remove')), 1)
    ...
    def test_login(self):
        ...
        self.assertEqualJSON(self.app.post(url('person_login_'), dict(username=username, password=password + 'x')), 0)
        # Log in using good credentials
        self.assertEqualJSON(self.app.post(url('person_login_'), dict(username=username, password=password)), 1)

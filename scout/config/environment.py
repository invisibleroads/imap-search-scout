...
from scout.lib import app_globals, helpers, store
from scout.config.routing import make_map
from scout.model import init_model
...
def load_environment(global_conf, app_conf):
    ...
    config = PylonsConfig()
    config.init_app(global_conf, app_conf, package='scout', paths=paths)
